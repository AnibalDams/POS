...
<div class="sale">
    <div class="header">
        ...
        <span style="font-size: 1.3rem; color:#333;font-weight:bold;"
            >¡Pago Realizado satifactoriamente!</span
        >
        <span style="font-size: 1.05rem;">Recibo #{saleId}</span>
        <span>{date}</span>
    </div>
    <div class="content">
        <span style="font-weight: bold; color:#333; font-size:1.1rem;"
            >Productos</span
        >
        <div class="products">
            {#each products as product}
                <div class="product">
                    ...
                    <span style="font-weight: bold; color:#333;"
                        >{product.product.price * product.amount}$</span
                    >
                </div>
            {/each}
        </div>
        ...
        <div class="actions">
            <Button
                style="width:calc(100%/2); cursor:pointer;"
                variant="outline"
                onclick={() => {
                    window.print();
            ...
            <Button
                style="width:calc(100%/2); cursor:pointer;"
                onclick={onFinish}><Check />Finalizar</Button
            >
        </div>
    </div>
</div>
